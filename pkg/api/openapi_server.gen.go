...
type ServerInterface interface {
	...
	// (POST /api/v3/jobs/{job_id}/settag)
	SetJobTag(ctx echo.Context, jobId string) error
...
func (w *ServerInterfaceWrapper) GetSharedStorage(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "audience", ctx.Param("audience"), &audience, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) GetJobType(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "typeName", ctx.Param("typeName"), &typeName, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
// SetJobTag converts echo context to params.
func (w *ServerInterfaceWrapper) SetJobTag(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "job_id" -------------
	var jobId string
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.SetJobTag(ctx, jobId)
	return err
}
...
func (w *ServerInterfaceWrapper) ShamanFileStoreCheck(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "checksum", ctx.Param("checksum"), &checksum, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "filesize", ctx.Param("filesize"), &filesize, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) ShamanFileStore(ctx echo.Context) error {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Shaman-Can-Defer-Upload")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-Shaman-Can-Defer-Upload", valueList[0], &XShamanCanDeferUpload, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false})
		if err != nil {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Shaman-Original-Filename")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-Shaman-Original-Filename", valueList[0], &XShamanOriginalFilename, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false})
		if err != nil {
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/api/v3/jobs/:job_id/settag", wrapper.SetJobTag)
