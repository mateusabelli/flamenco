...
func (m *MockCommandListener) TaskStep(arg0 context.Context, arg1 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockCommandListenerMockRecorder) TaskStep(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TaskStep", reflect.TypeOf((*MockCommandListener)(nil).TaskStep), arg0, arg1)
}
